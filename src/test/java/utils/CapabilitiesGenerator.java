...
public class CapabilitiesGenerator {
    ...
    public static ChromeOptions getChromeOptions() {
        ...
        if (os.contains("win")) {
            ...
            System.setProperty("webdriver.chrome.driver", driverPath + "/chromedriver-mac");
        } else {
            System.setProperty("webdriver.chrome.driver", driverPath + "/webdrivers/chromedriver-linux");
        }
